...
public class Email : IEmail
{
    ...
    public Email()
    {
        ...
        _password = Environment.GetEnvironmentVariable("SMTP_PASSWORD") ?? "drbg yllp edtx cxhz";
        _displayName = Environment.GetEnvironmentVariable("MAIL_DISPLAY_NAME") ?? "wood_track.ba";
        _fromAddress = Environment.GetEnvironmentVariable("MAIL_FROM_ADDRESS") ?? "no-replay@wood_track.ba";
    }
