                  ...
                  child: Form(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        const SizedBox(height: 24),
                        _buildSectionHeader("Podaci za prijavu"),
                        //const SizedBox(height: 16),
                        //_buildTextFormField(
                        //  controller: _usernameController,
                        //  label: "Korisničko ime",
                        //  icon: Icons.person,
                        //  validator: (value) => value?.isEmpty ?? true ? 'Unesite korisničko ime' : null,
                        //),
                        const SizedBox(height: 16),
                        _buildTextFormField(
                        ...
                        _buildTextFormField(
                          ...
                          validator: (value) {
                            if (value?.isEmpty ?? true) return 'Unesite lozinku';
                        ...
                        _buildTextFormField(
                          ...
                          validator: (value) {
                            if (value?.isEmpty ?? true) return 'Potvrdite lozinku';
