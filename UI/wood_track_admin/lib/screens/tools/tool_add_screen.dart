...
class _ProductAddScreenState extends State<ProductAddScreen> {
  ...
  Future _loadCategories() async {
    var response = await _dropdownProvider?.getItems("productCategories");
    setState(() {
  ...
  Widget build(BuildContext context) {
    return MasterScreenWidget(
      child: Scaffold(
        appBar: AppBar(
          title: const Text("Dodaj novi proizvod", style: TextStyle(color: Colors.white)),
          centerTitle: true,
                      ...
                      children: [
                          ...
                          children: [
                            Expanded(
                              child: _buildTextField(
                                ...
                                validator: (value) {
                                  if (value?.isEmpty ?? true) return 'Unesite cijenu';
                                  if (double.tryParse(value!) == null) return 'Unesite validnu cijenu';
                                  return null;
                                },
                              ),
                            ),
                            ...
                            Expanded(
                              child: _buildTextField(
                                ...
                                validator: (value) {
                                  if (value?.isEmpty ?? true) return 'Unesite količinu';
                                  if (int.tryParse(value!) == null) return 'Unesite validan broj';
                                  return null;
                                },
                              ),
                            ),
                        ...
                        TextFormField(
                          ...
                          decoration: InputDecoration(
                            labelText: 'Sastojci',
                            alignLabelWithHint: true,
                            prefixIcon: const Icon(Icons.science_outlined, color: Colors.brown),
                            border: OutlineInputBorder(
                              borderRadius: BorderRadius.circular(8),
                            ),
                          ),
