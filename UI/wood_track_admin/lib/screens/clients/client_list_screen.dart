...
import 'package:wood_track_admin/screens/clients/client_add_screen.dart';
import 'package:wood_track_admin/screens/clients/client_edit_screen.dart';
...
class _ClientListScreenState extends State<ClientListScreen> {
  ...
  Future<void> _generateReport() async {
    ...
    try {
      ...
      final pdfBytes = await reportsProvider.downloadClientsReport(
                  ...
                  Row(
                    children: [
                      ...
                      ElevatedButton.icon(
                        ...
                        label: const Text('Dodaj klijenta'),
                        style: ElevatedButton.styleFrom(
                        ...
                        onPressed: () {
                          Navigator.push(
                            context,
                            MaterialPageRoute(builder: (_) => const ClientAddScreen()),
                          );
                        },
                      ),
                    ],
                                        ...
                                        IconButton(
                                          ...
                                          onPressed: () {
                                            Navigator.push(
                                              context,
                                              MaterialPageRoute(
                                                  builder: (_) => ClientEditScreen(id: user.id)),
                                            );
                                          },
                                        ),
                                        IconButton(
    ...
    showDialog(
      ...
      builder: (BuildContext context) {
        return AlertDialog(
          ...
          content: Text(
              'Da li ste sigurni da želite obrisati klijenta ${user.firstName} ${user.lastName}?',
              textAlign: TextAlign.center),
          actions: [
            TextButton(
